    ...
    <div className="p-6 md:p-8 min-h-screen bg-enat-yellow-light/30">
      ...
      >
        ...
        <div className="relative flex-1 min-w-[220px] max-w-sm">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-enat-dark/50" />
          <input
            type="text"
            placeholder="Tìm kiếm nội dung..."
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-enat-green/30 focus:border-enat-green/40 transition-all placeholder:text-gray-400"
          />
        </div>
